...
with serial.Serial(
    ...
    while True:
        ...
        lines = [
            ...
            "",
            f"liveState: {liveState}",
            f"topLabel: {topName}",
            f"topProb: {topProb:.3f}",
            "",
            ...
            "",
            f"healthy: {probData['healthy']:.3f}",
            f"looseMounting: {probData['looseMounting']:.3f}",
            f"maxLoading: {probData['maxLoading']:.3f}",
            f"minLoading: {probData['minLoading']:.3f}",
            f"offAxis: {probData['offAxis']:.3f}",
            f"multipleFailures: {probData['multipleFailures']:.3f}",
        ]
        renderBlock(lines)
